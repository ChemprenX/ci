...
//        $no_case_url = $files['no_case_url'];
        ...
        if (!empty($is_case['case'])){
            $advertiser_logo = $this->input->post('advertiser_logo');//广告主logo
            $agency_company_logo = $this->input->post('agency_company_logo');//代理公司logo
            $visual_url = $this->input->post('visual_url');//作品主视觉
            $url = $this->input->post('url');//ppt
            $video_url = $this->input->post('video_url');//视频
...
//            $url = $this->image_service->save_ppt($url,'ppt');
        ...
        if (!empty($is_case['no_case'])){
            $no_case_advertiser_logo = $this->input->post('no_case_advertiser_logo');//广告主logo(非案例)
            $no_case_visual_url = $this->input->post('no_case_visual_url');//人物照片(非案例)
            $no_case_url = $this->input->post('no_case_url');//word(非案例)
