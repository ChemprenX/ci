<?php /* Smarty version Smarty-3.1.18, created on 2017-04-06 17:25:36
         compiled from "application/views/api/case/updatecase.html" */ ?>
<?php /*%%SmartyHeaderCode:35205783758e609903c7b95-12364004%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f1e64459b024557790d5e320e00f46e7e74d66f4' => 
    array (
      0 => 'application/views/api/case/updatecase.html',
      1 => 1489566462,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '35205783758e609903c7b95-12364004',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58e609904285f2_75110070',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58e609904285f2_75110070')) {function content_58e609904285f2_75110070($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("../common/header.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<div class="part twpart2 wrap twpart">
    ...
    <div class="main_zh clearfix">
        ...
        <div class="awardWarpDiv col-xs-10">
            ...
            <ul class="awardWrap">
                <form name="formCase" method="post" action="/index.php/api/cases/updatecaseact"
                      enctype="multipart/form-data" target="_self">
                    <input type="hidden" name="uid" id="uid" value="<?php echo get_cookie('uid');?>
"/>
                    <input type="hidden" name="cid_test" id="cid" value="<?php echo $_smarty_tpl->tpl_vars['case']->value['cid'];?>
"/>
                                            ...
                                            <li class="clearfix">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><em
                                                            class="red"> * </em>广告主名称：</span>
                                                    <input type="text" class="form-control" name="advertiser"
                                                           value="<?php echo $_smarty_tpl->tpl_vars['case']->value['advertiser'];?>
">
                                                </div>
                                            </li>
                                            <li class="clearfix">
                                            ...
                                            <li class="clearfix">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><em
                                                            class="red"> * </em>代理公司名称：</span>
                                                    <input type="text" name="agency_company" class="form-control"
                                                           value="<?php echo $_smarty_tpl->tpl_vars['case']->value['agency_company'];?>
">
                                                </div>
                                            </li>
                                            <li class="clearfix">
                                                <div class="input-group">
                                                <span class="input-group-addon "><em
                                                        class="red"> * </em>代理公司LOGO：</span>
                                                    <input type="file" class="form-control" id="file2"
                                                           name="agency_company_logo">
                                            ...
                                            <li class="clearfix">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                           value="<?php echo $_smarty_tpl->tpl_vars['case']->value['title'];?>
">
                                                </div>
                                            </li>
                                            <li class="clearfix">
                                            ...
                                            <li class="clearfix">
                                                <div class="input-group">
                                                <span class="input-group-addon"><em
                                                        class="holderBlock"></em>上传视频：</span>
                                            ...
                                            <dd class="cf on">
                                                ...
                                                <label>
                                                    <input name="award[]" type="checkbox"
                                                           value="2"/><span>场景营销类</span></label>
                                                <label>
                                                    <input name="award[]" type="checkbox"
                                                           value="3"/><span>移动营销类</span></label>
                                                <label>
                                                    <input name="award[]" type="checkbox"
                                                           value="22"/><span>大屏营销类</span></label>
                                                <label>
                                                    <input name="award[]" type="checkbox"
                                                           value="4"/><span>电商O2O类</span></label>
                                            </dd>
                                        </dl>
                                        <dl class="dllist cf on">
                                            <dt>
                                            ...
                                            <dd class="cf">
                                                ...
                                                <label>
                                                    <input name="award[]" type="checkbox"
                                                           value="27"/><span>智能营销类</span></label>
                                                <label>
                                                    <input name="award[]" type="checkbox"
                                                           value="6"/><span>大数据营销类</span></label>
                                                <label>
                                                    <input name="award[]" type="checkbox"
                                                           value="23"/><span>AR/VR类</span>
                                                </label>
                                                <!-- <label>
                                ...
                                <dl class="dllist cf case_detail" id="nocase_detail">
                                    ...
                                    <ul class="ul3 pad ul2 mb zw_a">
                                        <li class="clearfix">
                                            <div class="input-group">
                                                <span class="input-group-addon"><em
                                                        class="red"> * </em>报送公司：</span>
                                                <input type="text" id="" name="no_case_advertiser" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['case']->value['no_case_advertiser'];?>
">
                                            </div>
                                        </li>
                                        <li class="clearfix">
                                            <div class="input-group">
                                                <span class="input-group-addon"><em
                                                        class="holderBlock"></em>广告主LOGO：</span>
                                                <input type="file" class="form-control"
                                        ...
                                        <li class="clearfix">
                                            <div class="input-group">
                                                <span class="input-group-addon"><em
                                                        class="holderBlock"></em>人物照片：</span>
                                                <input type="file" class="form-control"
                            ...
                            <div class="nocase nocase2">
                                <div class="nocaseDllistWrap clearfix">
                                    <dl class="dllist cf on">
                                        ...
                                        <dd class="cf on">
                                            <label><input name="award[]" type="checkbox"
                                                          value="14"/><span>年度网络营销领军人物</span></label>
                                            <label>
                                                <input name="award[]" type="checkbox"
                                    ...
                                    <dl class="dllist cf on">
                                        ...
                                        <dd class="cf on">
                                            <!--<label>-->
                                            <!--<input name="award[]" type="checkbox" value="16" /><span>年度网络营销最佳数字代理机构</span></label>-->
                                            <label>
                                                <input name="award[]" type="checkbox"
                                    ...
                                    <dl class="dllist cf on">
                                        ...
                                        <dd class="cf on">
                                            <label>
                                                <input name="award[]" type="checkbox"
                                                       value="16"/><span>年度网络营销最佳数字代理机构排行榜</span></label>
                                        </dd>
                                    </dl>
                                </div>
                            </div>
                        ...
                        <div class="csjx_div paylabel">
                            <dl class="dllist cf on">
                                <dt>
                                    ...
                                    <label><input name="paytype" type="radio" value="2"
                                                  checked="checked"/><span>线下支付</span></label>
                                </dt>
                            </dl>
                        </div>
                        <div class="zw_a none zw_a1"><img src="/static/api/images/erb.jpg" width="430" height="430"/>
                        </div>
                        <div class="zw_a none zw_a2"><img src="/static/api/images/erb.jpg" width="430" height="430"/>
                        </div>
                        <div class="zw_a none zw_a3"><img src="/static/api/images/erb.jpg" width="430" height="430"/>
                        </div>
                        <div class="zw_a none zw_a4"><img src="/static/api/images/erb.jpg" width="430" height="430"/>
                        </div>
                        <div class="zw_a none zw_a5"><img src="/static/api/images/erb.jpg" width="430" height="430"/>
                        </div>
                    </div>
                    <div class="twentySubmitWrap">
                        <input type="submit" value="提交" class="submitBtn twentySubmit">
                    </div>
                </form>
            </ul>
        </div>
...
<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['case']->value['aid'];?>
" id="aidstr"/>
...
<script type="text/javascript">
    ...
    var aidstr = $("#aidstr").val();
    var aidarr = aidstr.split(",");

    $(".nocase input[type='checkbox']").each(function () {
        var value = $(this).val();
        var now_nocase_detail = $(this).closest(".nocase").find(".case_detail");
        if ($.inArray(value, aidarr) != -1) {
